        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="upload.php" method="POST" enctype="multipart/form-data">
                    <label for="nombre"><strong>Nombre de Estudiante:</strong></label>
                    <input type="text" id="nombre_est" name="nombre_est" required>
                    <label for="apellido"><strong>Apellido de Estudiante:</strong></label>
                    <input type="text" id="apellido_est" name="apellido_est" required>
